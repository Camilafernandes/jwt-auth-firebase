...
{
    /**
     * @var \Mockery\MockInterface|\CamilaFernandes\JWTAuth\Contracts\Providers\JWT
     */
    protected $jwt;

    /**
     * @var \Mockery\MockInterface|\CamilaFernandes\JWTAuth\Blacklist
     */
    protected $blacklist;

    /**
     * @var \Mockery\MockInterface|\CamilaFernandes\JWTAuth\Factory
     */
    protected $factory;
    ...
    /**
     * @test
     * @expectedException \CamilaFernandes\JWTAuth\Exceptions\TokenBlacklistedException
